...
import { BookOpen, PlayCircle, HelpCircle, Compass } from "lucide-react";
    ...
    <div className="mx-auto max-w-3xl py-8 px-4">
      ...
      <div className="mt-10 space-y-12">
        {block.topics.map((topic, idx) => (
          <section key={topic.id} className="scroll-mt-6">
            <div className="flex items-center gap-2.5 border-b border-slate-200 pb-3 mb-5">
              ...
              <span className="ml-auto text-xs font-semibold px-2 py-0.5 rounded bg-slate-100 text-slate-600">
                Track: {topic.track}
              </span>
            </div>
